...
/**The open media playlist object. All relevant
 * functions can be accessed via this object.
 * See demos and documentation for more information
 *
 * Please email me via my codecanyon profile
 * page (23andWalnut) or at help@23andwalnut.com
 * if you have any issues
 */
var openMediaPlaylist = function (config)
{
                ...
                openPlayerContent.animate({opacity: 1}, 'fast', function()
                {
                    if (style == 'fullscreen')
                    {
                        if (options.loadFirstItem && currentItem == null)
                        {
                            ...
                            var firstLink = $('.playlist a:first-child');
